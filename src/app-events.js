 ...
 * Emits 'session-state' when a session's activity snapshot changes.
 *
 ...
 * @param {{confirmed?: boolean, outcome?: string|null, source?: string|null, message?: string|null}} [details]
 */
export function emitSessionState(sessionId, target, state, activityChangedAt = null, details = {}) {
  appEvents.emit('session-state', {
    ...
    activity_message: details.message ?? null,
